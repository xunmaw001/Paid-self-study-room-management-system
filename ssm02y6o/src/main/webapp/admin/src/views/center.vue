  ...
  <div>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="商家账号" prop="shangjiazhanghao">
          <el-input v-model="ruleForm.shangjiazhanghao" readonly              placeholder="商家账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="商家名称" prop="shangjiamingcheng">
          <el-input v-model="ruleForm.shangjiamingcheng"               placeholder="商家名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='shangjia'" label="封面" prop="fengmian">
          <file-upload
          tip="点击上传封面"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='shangjia'"  label="营业许可" prop="yingyexuke">
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="联系电话" prop="lianxidianhua">
		...
		<el-form-item :style='{"width":"100%","padding":"0","margin":"0"}'>
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#000","width":"150px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onUpdateHandler">修 改</el-button>
		</el-form-item>
      </el-row>
    </el-form>
  </div>

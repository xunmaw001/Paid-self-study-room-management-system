		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"10%","padding":"0 10px","margin":"0 0 20px","background":"#fff"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","flexDirection":"column","display":"flex"}'>
					<el-button :style='{"border":"2px solid #fff","cursor":"pointer","padding":"0","margin":"0 0 6px","outline":"none","color":"#000","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(90deg, rgba(80, 165, 255, 0.5), rgba(255, 80, 80, 0.5))1 1","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('systemintro','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"2px solid ","cursor":"pointer","padding":"0","margin":"0 0 6px","outline":"none","color":"#000","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(90deg, rgba(80, 165, 255, 0.5), rgba(255, 80, 80, 0.5))1 1","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('systemintro','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#000","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('systemintro','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#000","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('systemintro','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#000","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('systemintro','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination

...
<view class="content">
	<view :style='{"width":"100%","padding":"0","position":"relative","background":"#E5FFFC","height":"auto"}'>
		<form :style='{"width":"94%","padding":"24rpx","margin":"5% 3%","background":"#fff","display":"block","height":"90%"}' class="app-update-pv">
			...
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="" @tap="valueTap">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#000000","textAlign":"right"}' class="title">值</view>
				<image :style='{"width":"80rpx","borderRadius":"100%","objectFit":"cover","display":"block","height":"80rpx"}' class="avator" v-if="ruleForm.value" :src="baseUrl+ruleForm.value" mode="aspectFill"></image>
